...
image: /assets/images/init-nvim/screen0.png
project: true
source: https://github.com/Blacksuan19/init-nvim/init.nvim
...
Neovim provides support for a wide range of languages by default. There is also
support for:
...
![fzf preview](/assets/images/init-nvim/screen1.png)

### Project wide search with fzf

![Rg preview](/assets/images/init-nvim/screen2.png)

### Git Status

![git status](/assets/images/init-nvim/screen3.png)

### workflow demo

{% include YouTube.liquid id="_R2K0MrGLLI" -%}
